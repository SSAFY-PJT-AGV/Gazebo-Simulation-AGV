...
class ArucoDemoDetector(Node):
    def __init__(self):
        ...
        self.image_topic = '/AGV02/agv02_camera/image_raw'
        ...
        self.get_logger().info('AGV02 ArUco Demo Detector Started')
    ...
    def image_callback(self, msg):
        ...
        for marker_id in detected_ids:
            ...
            self.get_logger().info('------------------------------------')
            self.get_logger().info(f'[AGV02] Detected marker_{marker_id}')
