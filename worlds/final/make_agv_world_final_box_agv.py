...
WORLD_PATH = Path.home() / "gazebo_agv_ws/src/agv_sim/worlds/agv_factory_final_box_agv.world"
    ...
    <model name="{name}">
      ...
      <link name="base_link">
        <collision name="body_collision">
          <geometry>
            <box>
              <size>0.5600 0.3800 0.1600</size>
            </box>
          </geometry>
        </collision>
        ...
        <visual name="front_direction_marker">
          <pose>0.2450 0 0.0900 0 0 0</pose>
          <geometry>
            <box>
              <size>0.0700 0.3000 0.0250</size>
            </box>
          </geometry>
          <material>
        ...
        <visual name="top_id_marker">
          <pose>0 0 0.1000 0 0 0</pose>
          <geometry>
            <box>
              <size>0.2600 0.2000 0.0250</size>
            </box>
          </geometry>
          <material>
        ...
        <visual name="left_front_wheel">
          <pose>0.1800 0.2250 -0.0450 0 0 0</pose>
          <geometry>
            <box>
              <size>0.1200 0.0550 0.0600</size>
            </box>
          </geometry>
          <material>
...
<sdf version="1.6">
  <world name="agv_factory_final_box_agv">
...
# 입고 박스 1개: 기존 출고 박스 3개 건너편에 빈 사각형 형태로 배치
INBOUND_SIZE = SMALL_SQUARE
INBOUND_BORDER = 0.045
in_x, in_y = INBOUND_BOX_CENTER
world += box_model("inbound_box_top_border", in_x, in_y + INBOUND_SIZE / 2, COLOR_BOX_Z, INBOUND_SIZE, INBOUND_BORDER, COLOR_BOX_HEIGHT, RED)
world += box_model("inbound_box_bottom_border", in_x, in_y - INBOUND_SIZE / 2, COLOR_BOX_Z, INBOUND_SIZE, INBOUND_BORDER, COLOR_BOX_HEIGHT, RED)
world += box_model("inbound_box_left_border", in_x - INBOUND_SIZE / 2, in_y, COLOR_BOX_Z, INBOUND_BORDER, INBOUND_SIZE, COLOR_BOX_HEIGHT, RED)
world += box_model("inbound_box_right_border", in_x + INBOUND_SIZE / 2, in_y, COLOR_BOX_Z, INBOUND_BORDER, INBOUND_SIZE, COLOR_BOX_HEIGHT, RED)

# AGV 모델: 원통형 대신 간단한 박스형 AGV로 변경
